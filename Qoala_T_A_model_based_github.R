...
# download.file("https://github.com/larawierenga/Qoala-T-under-construction/blob/master/simulated_data_A_model.Rdata?raw=true","simulated_data_A_model") # include path to your datafile 
# dataset_name <- "simulated_data_A_model" # edit to your dataset name
# load("simulated_data_A_model") # edit to your dataset name
...
Qoala_T_predictions$Scan_QoalaT <- round(rf.probs$Include*100,0)
