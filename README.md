...
- Next extract the following output txt files  using [fswiki](https://surfer.nmr.mgh.harvard.edu/fswiki/freesurferstats2table): aseg_stats.txt, aparc_volume_lh.txt, aparc_thickness_lh.txt, aparc_area_lh.txt, aparc_volume_rh.txt, aparc_thickness_rh.txt, aparc_area_rh.txt. 
