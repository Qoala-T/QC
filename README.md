...
- Next run [stats2table_bash_qoala_t.sh](https://github.com/larawierenga/Qoala-T-under-construction/blob/master/stats2table_bash_qoala_t.sh), an adapted version from [fswiki](http://www.nitrc.org/frs/download.php/4363/stats2table_bash.zip). To create an input file for the Qoala-T tool merge these files into one (see [example R script](https://github.com/larawierenga/Qoala-T-under-construction/blob/master/Qoala_T_merge_example_script.R)). 
